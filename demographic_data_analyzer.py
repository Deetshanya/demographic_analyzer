...
def calculate_demographic_data(print_data=True):
    # Read data from file
    df = pd.read_csv('adult_data.csv')  # Ensure this matches your file name
    ...
    top_IN_occupation = top_IN_occupation_series[0] if not top_IN_occupation_series.empty else None
